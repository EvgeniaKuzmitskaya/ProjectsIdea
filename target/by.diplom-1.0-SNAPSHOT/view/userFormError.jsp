...
<body>
<p class = "new">Неверный ввод логина и/или пароля. Введите данные заново</p>
<form id="loginForm" action="/userForm" method="post" modelAttribute="us">

    <div class="field">
        <label>Имя пользователя:</label>
        <div class="input"><input type="text" name="login" value="" id="${us.login}"/></div>
    </div>

    <div class="field">
        <label>Пароль:</label>
        <div class="input"><input type="password" name="password" value="" id="${us.password}" /></div>
    </div>
